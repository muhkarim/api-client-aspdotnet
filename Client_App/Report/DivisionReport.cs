...
namespace Client_App.Report
{
    public class DivisionReport
    {
        ...
        public byte[] PrepareReport(List<DivisionViewModel> divisions)
        {
            ...
            _document.Open();
            _pdfTable.SetWidths(new float[] { 20f, 150f, 150f, 150f });
            #endregion
        ...
        private void ReportBody()
        {
            ...
            foreach (DivisionViewModel div in _divisions)
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(div.DivisionName, _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(div.DepartmentName, _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(div.CreateDate.ToString(), _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
